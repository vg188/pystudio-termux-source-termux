...
PYSTUDIO_PROOT_EXTRA_PATCHES="pystudio-fork-trace.patch pystudio-reset-tracee-signal-mask.patch pystudio-fork-to-clone-seccomp.patch pystudio-signal-trace.patch"
